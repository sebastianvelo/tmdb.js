...
class Genre extends TMDBRequest {
  ...
  public getTVGenres = (params?: GenreParams) => this.get<Genres>(this.endpoints.TV_SHOWS(), params);

  public getMovieGenres = (params?: GenreParams) => this.get<Genres>(this.endpoints.MOVIES(), params);
}
